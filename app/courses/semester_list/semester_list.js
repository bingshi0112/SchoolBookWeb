...
var SemesterListComponent = (function () {
    function SemesterListComponent(coursesListService, route) {
    ...
    SemesterListComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.forEach(function (params) {
            ...
            _this.coursesListService.getSemestersPerUniversity(_this.uni).then(function (response) {
...
//# sourceMappingURL=semester_list.js.map